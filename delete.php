                        ...
                        <form method="POST" action="delete.php">
                                <?php
                                    if($Error != "") {
                                        ...
                                        echo "<h4 style='font-weight:normal;padding-left:10px;text-align:center;'>Are you sure you want to delete this post?</h4>";
                                        $user = new User();
                                        $one_user = $user->get_user($row['userid']);
                                        include('deletePost.php');
                                        $postid = $row['postid'];
                                        echo "<input type='hidden' name='postid' value='$row[postid]'>";
                                        echo "<input type='submit' name='post' value='Delete' style='margin-top:-50px;margin-left:1000px;margin-bottom:5px;background-color:#405d9b;border-radius:3px;padding:5px;border:none;color:white;margin-right: 5px;'>";                                      
                                    }
                                ?>
